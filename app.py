...
def calcola_microclima(temp_aria, temp_radiante, vel_aria, umidita, metabolismo, isolamento):
    """
    Calcola PMV e PPD utilizzando le formule della norma UNI EN ISO 7730.
    """
    try:
...
def genera_grafico_pmv_ppd(pmv, ppd):
    """
    Genera un grafico che mostra la relazione tra PMV e PPD.
    """
